...
- **범용성 및 저작권 준수**: 애프터로그는 **모든 테마형 보드게임에 적용 가능한 범용 엔진**으로 설계되었습니다. 다만, 기존 IP(예: 광기의 저택 등)와의 저작권 분쟁을 피하고 고유한 데모를 선보이기 위해, 프로젝트에서는 자체 기획한 **'스페이스 호러 협력 게임'**을 대표 예시로 사용하여 구현되었습니다.
